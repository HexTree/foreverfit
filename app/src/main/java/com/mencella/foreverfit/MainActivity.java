package com.mencella.foreverfit;
...
import com.mencella.receivers.AlarmReceiver;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public static int DEFAULT_POSTPONE_DURATION = 3000; // 5mins
    public static int DEFAULT_INTERVAL_DURATION = 6000; // 20mins
