...
import com.mencella.foreverfit.R;
...
public class AlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        PendingIntent piNow = PendingIntent.getBroadcast(context, 0, new Intent(context, NowReceiver.class), PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        NotificationCompat.Builder nBuilder = new NotificationCompat.Builder(context)
                ...
                .addAction(R.drawable.fit_now, context.getResources().getString(R.string.lets_go), piNow)
                .addAction(R.drawable.fit_later, context.getResources().getString(R.string.later), piLater)
